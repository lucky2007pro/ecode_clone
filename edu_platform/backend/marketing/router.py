...
async def get_marketing_settings(school_id: uuid.UUID, db: AsyncSession = Depends(get_db), token_school_id=Depends(get_current_school_id)):
...
async def update_marketing_settings(school_id: uuid.UUID, data: MarketingUpdate, db: AsyncSession = Depends(get_db), token_school_id=Depends(get_current_school_id)):
